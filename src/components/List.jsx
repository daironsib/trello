...
class List extends React.Component {
  constructor(props, context) {
    ...
    this.id = props.id
    this.lists = props.store.getState().lists
    this.currentList = this.lists.find(list => list.id === this.id ? list : false)
  }

  handlerListDelete = () => {
    this.props.onListDelete(this.currentList.id)
  }

  handlerAddTask = () => {
    this.props.onAddTask(this.currentList.id)
  }
      ...
      <section className="list-wrapper">
        <div className="list">
          <div className="list-header">
            <div className="name">{ this.currentList.title }</div>
          ...
          <div className="cards-wrapper">
            <div className="cards">
              <TaskContainer listId={ this.currentList.id } key={ this.currentList.id } />
            </div>
          </div>
        </div>
