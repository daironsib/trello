      ...
      <section className="list-wrapper">
        <div className="list">
          <div className="list-header">
            ...
            <div className="delete-list-wrapper" onClick={ () => this.handleListDelete(this.props.id) }>
          ...
          <div className="cards-wrapper">
            <div className="cards">
              { this.props.tasks.map(task =>
                <Task id={ task.id } title={ task.title } completed={ task.completed } taskEditing={ task.taskEditing } key={ task.id } onChange={ this.handleStatusChange } onDelete={ this.handleTaskDelete } />)
              }
            </div>
          </div>
        </div>
        ...
        <div className="add-card-button-wrap">
          <button className="add-card-button" onClick={ () => this.handleAddTask(this.props.id) }>+</button>
        </div>
      </section>
    )
  }
