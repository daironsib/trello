...
class Task extends React.Component {
  constructor(props, context) {
    ...
    this.className = `item${this.props.completed ? ' completed' : ''}`
  }
    ...
    return (
      <div className={ this.className }>
        <div className="checkbox-cont">
          <input type="checkbox" onClick={ this.handleTaskChange } defaultChecked={ this.props.completed } />
        </div>
        <div className="name">
          { this.props.taskEditing ? <input type="text" defaultValue={ this.props.title } onKeyPress={ (e) => console.log(e) } autoFocus /> : <span>{ this.props.title }</span> }
        </div>
